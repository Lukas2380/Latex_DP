...
\newglossaryentryfast{void}{Void}{Das Void ist die Dunkelheit unter der Spielwelt Wenn ein Spieler hineinfällt stirbt dieser oder bekommt Schaden}

\newglossaryentryfast{index}{Index}{Index ist eine Stelle in einem Array}

\newglossaryentryfast{iteriert}{Iteriert}{Iterieren ist der Prozess des durchlaufens einer Sammlung von Daten}
