...
\begin{figure}[H]
  \centering
  \subfloat[Logo der HTL Braunau.]{\label{fig:a}\includegraphics[width=.25\textwidth]{./media/images/htl_moedling_logo.jpg}}
  \qquad
  \subfloat[Logo der HTL Braunau.]{\label{fig:b}\includegraphics[width=.25\textwidth]{./media/images/htl_moedling_logo.jpg}}
  \label{fig:canvas_01}
...
\begin{figure}[H]
  \centering
  \subfloat[Logo]{\label{fig:c}\includegraphics[width=.15\textwidth]{./media/images/htl_moedling_logo.jpg}}
  \qquad
  \subfloat[Logo]{\label{fig:d}\includegraphics[width=.15\textwidth]{./media/images/htl_moedling_logo.jpg}}
\qquad
  \subfloat[Logo]{\label{fig:e}\includegraphics[width=.15\textwidth]{./media/images/htl_moedling_logo.jpg}}
  \label{fig:canvas_04}
